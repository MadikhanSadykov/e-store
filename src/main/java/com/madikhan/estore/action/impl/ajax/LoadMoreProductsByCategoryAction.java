...
public class LoadMoreProductsByCategoryAction implements Action {
    ...
    private static final int SUBSTRING_INDEX = LOAD_MORE_PRODUCTS_BY_CATEGORY_PATH.length();
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException,
        ...
        List<Product> products = productService
                .listProductsByCategory(categoryUrl, getPage(request), MAX_PRODUCTS_PER_HTML_PAGE, languageID);
