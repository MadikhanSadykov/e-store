...
public class AccountRequestStatisticsListener implements ServletRequestListener {
    ...
    public void requestInitialized(ServletRequestEvent sre) {
        ...
        List<String> actions = (List<String>) req.getSession().getAttribute(NamesConstants.ACCOUNT_ACTIONS_HISTORY);
        if(actions == null) {
            actions = new ArrayList<>();
            req.getSession().setAttribute(NamesConstants.ACCOUNT_ACTIONS_HISTORY, actions);
        }
